...
async fn main() {
    ...
    let mut circuit : circuit = circuit{wires: Vec::new(), gates: Vec::new()};
    circuit.add_gate(Rect{w: 100.0, h: 100.0, x: 0 as f32, y: 0 as f32}, 0, 0, gate_type::AND);
    circuit.add_gate(Rect{w: 100.0, h: 100.0, x: 100 as f32, y: 0 as f32}, 0, 0, gate_type::OR);
    circuit.add_gate(Rect{w: 100.0, h: 100.0, x: 200 as f32, y: 0 as f32}, 0, 0, gate_type::NAND);
    circuit.add_gate(Rect{w: 100.0, h: 100.0, x: 300 as f32, y: 0 as f32}, 0, 0, gate_type::XOR);
    circuit.add_gate(Rect{w: 100.0, h: 100.0, x: 400 as f32, y: 0 as f32}, 0, 0, gate_type::XNOR);
    circuit.add_gate(Rect{w: 100.0, h: 100.0, x: 500 as f32, y: 0 as f32}, 0, 0, gate_type::NOR);
